...
import { svgCommandsToPdfOps } from './pdfPageSvg.js';
...
// ---------------------------------------------------------------------------
// Text wrapping (re-exported from pdfPageText for backward compatibility)
// ---------------------------------------------------------------------------

export { wrapText, breakWord } from './pdfPageText.js';
