...
function applyOverflow(
   ...
   availableWidth, 
   fontSize, 
   options?): OverflowResult;
```

Defined in: [src/layout/overflow.ts:275](https://github.com/ABCrimson/modern-pdf-lib/blob/41e38d3cdf2c93941dd206dd1bfad0f001b30727/src/layout/overflow.ts#L275)
