...
[modern-pdf-lib](../index.md) / generateListboxAppearance

# Function: generateListboxAppearance()

> **generateListboxAppearance**(`options`): [`PdfStream`](../classes/PdfStream.md)

Defined in: [src/form/fieldAppearance.ts:346](https://github.com/ABCrimson/modern-pdf-lib/blob/5f326ba39cc414c1559c669879130eaa00d3e49e/src/form/fieldAppearance.ts#L346)
