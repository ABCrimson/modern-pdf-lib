...
function computeImageDpi(
   ...
   imageHeight, 
   displayWidth, 
   displayHeight): ImageDpi;
```

Defined in: [src/assets/image/dpiAnalyze.ts:57](https://github.com/ABCrimson/modern-pdf-lib/blob/41e38d3cdf2c93941dd206dd1bfad0f001b30727/src/assets/image/dpiAnalyze.ts#L57)
