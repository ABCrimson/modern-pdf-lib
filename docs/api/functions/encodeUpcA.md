...
```ts
function encodeUpcA(data): BarcodeMatrix;
```

Defined in: [src/barcode/upc.ts:60](https://github.com/ABCrimson/modern-pdf-lib/blob/4c6faf7ea78c1427e7e0b3e77475e1cab1cc8964/src/barcode/upc.ts#L60)
