...
```ts
function generateSrgbIccProfile(): Uint8Array;
```

Defined in: [src/compliance/srgbIccProfile.ts:237](https://github.com/ABCrimson/modern-pdf-lib/blob/41e38d3cdf2c93941dd206dd1bfad0f001b30727/src/compliance/srgbIccProfile.ts#L237)
